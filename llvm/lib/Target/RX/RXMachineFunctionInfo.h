//=- RXMachineFunctionInfo.h - RX machine function info -----*- C++ -*-=//
//
...
/// RXMachineFunctionInfo - This class is derived from MachineFunctionInfo
/// and contains private RX-specific information for each MachineFunction.
...
public:
  //  RXMachineFunctionInfo() = default;

  RXMachineFunctionInfo(MachineFunction &MF) : MF(MF) {}
